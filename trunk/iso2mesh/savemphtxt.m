...
%
% input:
%      node: input, node list, dimension (be,3)
%      face: input, surface face element list with label, dimension (be,4)
%      elem: input, tetrahedron element list with label, dimension (be,5)
...
%
    ...
    n_elem = size(elem,1);
    fp = fopen(filename,'w');
    fprintf(fp,'# Created by save_mphtxt(danielkim@gist.ac.kr)\n');
    fprintf(fp,'0 1\n1\n5 mesh1\n1\n3 obj\n\n');
    fprintf(fp,'0 0 1\n4 Mesh\n2\n3\n%d\n1\n',n_node);
